...
async def start_bot(message: types.Message, keyboard: object = None):
    await message.answer(f"Приветствую, {message.from_user.full_name}", reply_markup=keyboard)
    kb = [
        [
            types.KeyboardButton(text="Мотивашку!")
        ],
    ]
    ...
    await message.answer("Моя задача мотивировать тебя, жми кнопку!", reply_markup=keyboard)


@dp.message_handler(Text(equals="Мотивашку!"))
